...
//= = = = = = = = 2
// [объект Moore Hensley, объект Sharlene Bush, объект Carey Barr]поле eyeColor)
...
const getUsersByGender = (arr, gender) => arr.filter(item => item.gender === gender).map(obj => obj.name);
console.log(getUsersByGender(users, "male"));

//= = = = = = = = 4
// [объект Moore Hensley, объект Ross Vazquez, объект Blackburn Dotson]

const getInactiveUsers = arr => arr.filter(item => !item.isActive);
console.log(getInactiveUsers(users));

//= = = = = = = = 5
// obj -name:"Elma Head"  , obj = name:"Sheree Anthony"
